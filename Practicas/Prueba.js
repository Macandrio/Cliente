...
function crearjson(){
    ...
    if(lista_borrar){
        ...
        viajes.forEach( viaje => {
            ...
            lista_span.setAttribute('class' , 'detalle');
            ...
            lista_img.addEventListener('mousemove' , function(){
                                                                    lista_span.setAttribute('class' , 'destacado');
            });

            lista_img.addEventListener('mouseleave' , function(){
                                                                    lista_span.setAttribute('class' , 'reserva');
            });
...
function reserva(){
    var nombre = prompt('Introduce el nombre de la reserva');

    if(nombre){
        document.cookie = 'nombre=' + nombre + '; max-age=86400; path=/';
        alert('Su reserva se a guardado correctamente ' + nombre)
    }else{
